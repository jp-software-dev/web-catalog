    ...
    <div className="w-full bg-brand-dark">
      <section className="relative min-h-[60vh] flex items-center justify-center bg-brand-black overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center space-y-8 animate-fade-in-up">
          <p className="text-sm font-bold text-brand-gold uppercase tracking-[0.3em]">Sobre Nosotros</p>
          <h1 className="text-4xl md:text-6xl font-black text-white leading-tight drop-shadow-2xl">Expertos en <span className="text-brand-gold border-b-2 border-brand-gold">Transmisiones</span> y Direcciones.</h1>
        </div>
      </section>
      ...
      <section className="bg-brand-black/90 backdrop-blur-md py-24 px-4 border-y border-gray-900">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="w-full md:w-1/2">
            <img src={nosotrosHistoria} alt="Nuestra historia en el taller" loading="lazy" decoding="async" className="w-full h-auto rounded-sm border border-gray-800 shadow-2xl grayscale hover:grayscale-0 transition-all duration-500" />
          </div>
        </div>
      </section>
      ...
      <section className="bg-brand-dark py-20 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-brand-card/80 border border-gray-800 rounded-sm overflow-hidden group shadow-lg flex flex-col">
            <img src={nosotros1} alt="Experiencia" loading="lazy" decoding="async" className="w-full h-56 object-cover grayscale group-hover:grayscale-0 transition-all duration-500 opacity-80 group-hover:opacity-100" />
            <div className="p-8 flex-grow">
              <h3 className="text-xl font-black text-brand-gold uppercase mb-3">Experiencia Técnica</h3>
          ...
          <div className="bg-brand-card/80 border border-gray-800 rounded-sm overflow-hidden group shadow-lg flex flex-col">
            <img src={nosotros2} alt="Calidad" loading="lazy" decoding="async" className="w-full h-56 object-cover grayscale group-hover:grayscale-0 transition-all duration-500 opacity-80 group-hover:opacity-100" />
            <div className="p-8 flex-grow">
              <h3 className="text-xl font-black text-brand-gold uppercase mb-3">Calidad Original</h3>
          ...
          <div className="bg-brand-card/80 border border-gray-800 rounded-sm overflow-hidden group shadow-lg flex flex-col">
            <img src={nosotros3} alt="Garantía" loading="lazy" decoding="async" className="w-full h-56 object-cover grayscale group-hover:grayscale-0 transition-all duration-500 opacity-80 group-hover:opacity-100" />
            <div className="p-8 flex-grow">
              <h3 className="text-xl font-black text-brand-gold uppercase mb-3">Garantía Total</h3>
