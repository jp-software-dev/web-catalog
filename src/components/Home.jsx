    ...
    <div className="w-full bg-transparent">
      <div className="relative h-[85vh] w-full flex items-center justify-start overflow-hidden">
        <div className="relative z-10 px-4 lg:px-16 max-w-7xl w-full animate-fade-in-up">
          ...
          <button onClick={() => setView('catalog')} className="group mt-10 px-10 py-4 bg-brand-gold text-black font-black uppercase tracking-widest rounded-sm hover:bg-yellow-500 hover:scale-105 transition-all shadow-[0_0_20px_rgba(212,175,55,0.4)] flex items-center gap-2">
            Catálogo Online 
            <span className="inline-block transition-transform duration-300 group-hover:-rotate-45 text-xl leading-none">→</span>
          </button>
        </div>
      </div>

      <div className="bg-brand-card/80 backdrop-blur-md border-y border-gray-800 py-8">
      ...
      <div className="bg-transparent py-24 px-4 border-b border-gray-900">
