export default function Contact() {
  return (
    <section className="bg-brand-black/90 backdrop-blur-sm py-24 px-4 min-h-screen flex items-center border-t border-gray-900">
      <div className="max-w-6xl mx-auto flex flex-col gap-12 w-full animate-fade-in-up text-center">
        
        <div className="space-y-4">
             <span className="text-brand-gold font-bold text-sm uppercase tracking-widest block">Ubicación del Taller</span>
             <h3 className="text-4xl md:text-6xl font-black text-white">Visítanos en Toluca</h3>
        ...
        <div className="flex flex-col md:flex-row gap-8 mt-8">
           <div className="w-full md:w-1/3 flex flex-col gap-6">
              <div className="bg-brand-card p-8 rounded-sm border border-gray-800 flex flex-col items-center justify-center text-center h-full">
              ...
              <div className="bg-brand-card p-8 rounded-sm border border-gray-800 flex flex-col items-center justify-center text-center h-full group">
          ...
          <div className="w-full md:w-2/3 h-[500px] bg-brand-card rounded-sm border border-brand-gold/50 overflow-hidden shadow-[0_0_30px_rgba(212,175,55,0.15)] grayscale hover:grayscale-0 transition-all duration-700">
            <iframe 
